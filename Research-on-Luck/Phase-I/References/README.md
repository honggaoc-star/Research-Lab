...
- [27 — CF-01 Tier 2 Pass B Coder Packet](27-CF-01-Tier-2-Pass-B-Coder-Packet.md) — freezes the single cumulative release through 26 November 1989, the two authorized sources, realization and foreclosure rules, actor boundaries, and independent coder forms.
- [28 — CF-01 Pass B Coder Alpha Locked Record](28-CF-01-Pass-B-Coder-Alpha-Locked.md) — preserves Independent Coder Alpha’s locked cumulative Pass B submission verbatim.
- [29 — CF-01 Pass B Coder B Locked Record](29-CF-01-Pass-B-Coder-B-Locked.md) — preserves Independent Coder B’s locked cumulative Pass B submission verbatim.
- [30 — CF-01 Pass B Agreement and Adjudication](30-CF-01-Pass-B-Agreement-and-Adjudication.md) — reports 15/18 strict stage-component agreement, 3/3 final-category agreement, adjudicates the recognition-status allocation, and closes CF-01 without independent audit.
