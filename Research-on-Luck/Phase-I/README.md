# Research on Luck — Phase I

**Status:** Completed first research cycle / Phase I.

This directory preserves the completed first cycle of the Research on Luck project as a coherent historical record. Phase I developed an interdisciplinary architecture for examining how consequential uncertainty matters to the trajectories of bounded systems. Its canonical definition treats luck as an **ex post relational evaluation of how consequential uncertainty affected a specified system's trajectory relative to a stated reference and feasible alternatives**.

Later phases may reuse, reinterpret, place downstream, or retire Phase I constructs. They do not retroactively rewrite this phase; the materials here retain the questions, propositions, evidence, decisions, and limits of the completed cycle.
...
The [FLEM-01 methodological synthesis](Measurement/18-FLEM-01-Methodological-Synthesis-and-Stage-2-Recommendation.md) closes the Tier 1 learning cycle. The [validation protocol](Measurement/16-Validation-Study-Recognition-Without-Realization.md) and [coding instrument](Measurement/17-Recognition-Episode-Coding-and-Source-Plan.md) are now Version 0.2. Cold Fusion is complete as the Tier 2 controlled replication. Its [Pass B agreement and adjudication](References/30-CF-01-Pass-B-Agreement-and-Adjudication.md) records 15/18 strict stage-component agreement and 3/3 final-category agreement, resolves the distinction between historical recognition and later claim credibility, classifies all three frozen candidates as premature recognition without categorical falsehood or foreclosure, and closes the cycle without independent audit.

The [pilot decision gate](Measurement/19-Pilot-Decision-Gate-and-Stage-2-Direction.md) gives a **conditional GO to Stage 2 Science design**. Betamax is deferred; Microsoft is reclassified as a possible within-system episode population; and Kodak is retained conditionally as an optional later portability or boundary-stress test.
