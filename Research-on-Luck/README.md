...
The [Stage 2 Science feasibility and sampling-frame record](Measurement/20-Stage-2-Science-Feasibility-and-Sampling-Frame.md) narrows the next phase to **Stage 2A frame construction**. The existing Science cases remain purposive calibration material and must not be treated as a representative or outcome-independent sample. Bounded source reconnaissance may proceed, but substantive coding and recognition–outcome analysis remain unauthorized until a concrete frame with a reproducible denominator, comparable evidence, explicit missingness, and pre-specified stop conditions passes the gate. This decision does not validate Proposition 4, causal effects, prevalence, or cross-domain portability.
