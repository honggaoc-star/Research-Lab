# Fleming and Penicillin — Bounded Pass B Coder Packet
...
No broader label such as “the penicillin opportunity” may replace these candidates.

## Temporal Boundary and Checkpoints
...
| Pursuit: code and reason | |
| Realization: code and reason | |
| Foreclosure: code and reason | |
| Actor or system transition since prior checkpoint | |
